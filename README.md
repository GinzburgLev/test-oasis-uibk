![docker image](https://github.com/GinzburgLev/test-oasis-uibk/actions/workflows/docker-publish.yml/badge.svg)
...
2. Clone the repository or download the repository as a zip file.
    ...
    ```sh
    git clone https://github.com/GinzburgLev/test-oasis-uibk.git
    cd test-oasis-uibk
    ```
    ...
    ```sh
    curl-L -o test-oasis-uibk.zip "https://github.com/GinzburgLev/test-oasis-uibk/archive/main.zip"
    unzip test-oasis-uibk.zip
    cd test-oasis-uibk
    ```
...
your `docker-compose.yaml` with `ghcr.io/ginzburglev/test-oasis-uibk:main` for the services
...
```sh
docker pull ghcr.io/ginzburglev/test-oasis-uibk/jupyter:main
```
...
_I get an_ `Error response from daemon: Head "https://ghcr.io/v2/GinzburgLev/test-oasis-uibk/manifests/main": unauthorized`
